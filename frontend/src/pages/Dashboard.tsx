      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "24px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div className="glass-card" style={{ padding: "20px" }}>
            ...
            <button onClick={handlePredict} disabled={loading} className="btn-primary" style={{ width: "100%" }}>
              {loading ? "Predicting..." : "Get Prediction"}
            </button>
          </div>

          {prediction && (
            <div className={`glass-card risk-bg-${prediction.risk_level}`} style={{ padding: "20px", border: "1px solid", transition: "all 0.3s ease" }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "16px" }}>
                <h3 style={{ color: "#F8FAFC", fontWeight: "600" }}>Route {prediction.route_id}</h3>
